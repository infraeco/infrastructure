...
int row[4500],col[2700],markx[4500],marky[2700],flagx[4500],flagy[2700],tui[4500][2700];
double c[4500][2700],a[4500],b[2700],ans[4500][2700],w[4500],v[2700],eva[4500][2700];
...
{
	int i,j;
	while ((tota>0.000001)&&(totb>0.000001))	
	{
		cmin=-1;
		x=0;
		y=0;
...
int main()
{
    ...
    //m=3;
	//n=4; 
	fp1 = fopen("Data input-carbon.xls","r");
    fp2 = fopen("Data output-carbon.xls","a+");
    inputdata();
    printf("m: %d  n: %d\n",m,n);
	for (i=1;i<=m;i++)
		for (j=1;j<=n;j++)
